"""
Copyright (c) Jaewoo Lee, and Om kiyoung
...
class ValueDecisionTransformer(DecisionTransformer):
    ...
    def forward(
        ...
        return state_preds, action_preds, return_preds, value_preds
    ...
    def get_predictions(
        ...
        state_preds, action_preds, return_preds, value_preds = self.forward(
            states,
            actions,
            None,
            returns_to_go,
        ...
        if self.stochastic_policy:
            return state_preds[:, -1], action_preds, return_preds[:, -1], value_preds[:, -1]
        else:
            return (
                state_preds[:, -1],
                self.clamp_action(action_preds[:, -1]),
