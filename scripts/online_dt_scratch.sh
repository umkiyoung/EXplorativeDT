...
# python /home/jaewoo/research/EXplorativeDT/main.py --learning_from_offline_data=$learning_from_offline_data --device=$device --env=halfcheetah-medium-v2 --num_updates_per_pretrain_iter=0 --learning_rate=0.0001 --weight_decay=0.0005 --eval_context_length=5 --eval_rtg=6000 --online_rtg=12000
